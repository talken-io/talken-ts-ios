...
#if !(defined (__x86_64__) || defined (__arm64__)) //MYSEO 32Bit
...
#define NTL_WNBITS_MAX (62)
#define NTL_DOUBLE_PRECISION (53)
#define NTL_FDOUBLE_PRECISION (((double)(1L<<52)))
#define NTL_LONGDOUBLE_OK (1)
#define NTL_LONGDOUBLE_PRECISION (64)
#define NTL_WIDE_DOUBLE_LDP ((wide_double(1L<<62))*(wide_double(1L<<1)))
